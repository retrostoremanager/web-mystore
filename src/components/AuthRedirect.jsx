...
const RESERVED_SLUGS = new Set(['dashboard', 'signup', 'verify', 'forgot-password', 'reset-password', 'set-password', 'login', 'c', 'api', 'admin', 'consignment', 'trade-ins', 'trade-in', 'settings', 'privacy', 'terms', 'checkout', 'sales-history', 'inventory', 'customers', 'users', 'roles', 'profile', 'subscription', 'billing', 'promotions']);
