...
const Dashboard = () => {
  ...
  const sections = [
    ...
    { title: 'Promotions', description: 'Create and manage store promotions and discounts', icon: <LocalOffer sx={{ fontSize: 48 }} />, color: 'error', route: '/dashboard/promotions', permission: 'promotion.manage' },
